...
public class VillagerCommandHandler extends EntityCommandHandler<VillagerEntityMCA> {
    ...
    public boolean handle(ServerPlayerEntity player, String command) {
        ...
        if (Chore.byCommand(command).filter(chore -> {
            ...
            entity.sendChatMessage(new TranslatableText("adult.chore.success"), player);
            return true;
        }).isPresent()) {
            return true;
        }
        ...
        switch (command) {
            ...
            case "procreate":
                ...
                return true;
            case "divorcePapers":
                player.inventory.insertStack(new ItemStack(ItemsMCA.DIVORCE_PAPERS.get()));
                return true;
            case "divorceConfirm":
            ...
            case "apologize":
                ...
                entity.world.getNonSpectatingEntities(VillagerEntityMCA.class, new Box(entityPos, entityPos).expand(32)).forEach(v -> {
            ...
            case "location":
                ...
                BlockPos pos = FuzzyPositionsCompat.localFuzz(entity.getRandom(), 1024, 0).add(entity.getBlockPos());
                ...
                break;
            case "slap":
                player.damage(DamageSource.CRAMMING, 1.0f);
                break;
        }
